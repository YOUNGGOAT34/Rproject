...
```
**Task 3: Creating a Dataframe and plot**
```{r}
# Define the vectors
weight <- c(60, 72, 57, 90, 95, 72)
height <- c(1.75, 1.8, 1.65, 1.9, 1.74, 1.91)
...
```
**Task 4:Create a dataframe and a plot**
...
**Task 5:Calculate Corpulence Index(CI)**
```{r}
#task 5
...
**Task 6: Calculate the quantiles and plot.**
```{r}
# task 6
